 ...
 *
 */
public class EnigmaFrontGroup extends TransformGroup implements PropertyChangeListener {

   Alpha alpha;
   RotationInterpolator rotationInterpolator;
   EnigmaFront panel;

   public EnigmaFrontGroup(Appearance tex, Appearance tex2, Appearance appearance) {
      Transform3D t = new Transform3D();
      panel = new EnigmaFront(tex, tex2, appearance);
   ...
   public void propertyChange(PropertyChangeEvent e) {
      if(e.getPropertyName().equals("EnigmaFrontSelection")) {
	 panel.movePanel();
      }
